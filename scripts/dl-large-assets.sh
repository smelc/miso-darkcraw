...
declare -r FILES="blue_slot.png card-bg-human.png card-bg-undead.png deck.png errbox.png forest.png forest-hand.png red_slot.png singleplayer.png torchs.png turn.png welcome.png"
